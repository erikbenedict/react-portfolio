  ...
  return (
    <footer className="flex justify-center max-w-[75%] md-max-w-[65%] mx-auto mb-10">
      <a href="#" className="to-top">
        <i className="fa-solid fa-arrow-up-from-bracket text-5xl mr-6"></i>
      </a>

      <a href="mailto:erik.r.benedict@gmail.com">
        <i className="fa-solid fa-envelope text-5xl mr-6"></i>
      </a>
      ...
      <a
        ...
        rel="noreferrer"
      >
        <i className="fa-brands fa-github text-5xl mr-6"></i>
      </a>
      ...
      <a
        ...
        rel="noreferrer"
      >
        <i className="fa-brands fa-linkedin text-5xl mr-6"></i>
      </a>
